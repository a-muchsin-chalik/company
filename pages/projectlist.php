        ...
        <?php
            ...
            echo '<tr><td colspan="5">Tidak ada data!</td></tr>';
                ...
                foreach ($arrayResult as $dataProject) {
                    ...
                    echo '<td>
                    <a class="btn btn-warning btn-sm" href="index.php?p=project&pnumber='.$dataProject->pnumber.'">Edit</a> | <a class="btn btn-danger btn-sm" href=“index.php?p=deleteproject&pnumber='.$dataProject->pnumber.'"
