    ...
    <form action="" method="post">
        <table class="table" border="0">
            <tr>
                ...
                <td>:</td>
                <td><input type="text" class="formcontrol" name="pnumber" value="<?php echo $objProject->pnumber; ?>"></td>
            </tr>
            <tr>
                <td>Project Name</td>
                <td>:</td>
                <td><input type="text" class="formcontrol" name="pname" value="<?php echo $objProject->pname; ?>"></td>
            </tr>
            <tr>
                <td>Location</td>
                <td>:</td>
                <td><input type="text" class="formcontrol" name="plocation" value="<?php echo $objProject->plocation; ?>"></td>
            </tr>
            <tr>
                <td>Department</td>
                <td>:</td>
